...
df = pd.read_csv("/Users/kaipatel/Documents/SpywareProject/data/bulb2_windows.csv")
...
requested_cols = [
    'packetCount', 'avgPacketLength', 'stdPacketLength',
    'uniqueSrcIPs', 'uniqueDstIPs',
    'uniqueTCPSrcPorts', 'uniqueTCPDstPorts',
    'uniqueUDPSrcPorts', 'uniqueUDPDstPorts',
    'TCPPacketCount', 'UDPPacketCount',
    'avgInterArrivalTime', 'stdInterArrivalTime',
    'avgTTL', 'stdTTL',
    'avgIPLen', 'stdIPLen',
    'avgTCPLen', 'stdTCPLen',
    'tcpPayloadPacketCount', 'uniqueTCPStreams',
    'tcpFlagSynCount', 'tcpFlagAckCount', 'tcpFlagFinCount',
    'tcpFlagRstCount', 'tcpFlagPshCount',
